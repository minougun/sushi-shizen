...
const translations = {
  ...
  ko: {
    ...
    hero_highlight_4: "타베로그(일본 최대 레스토랑 예약 사이트)에서 예약 가능",
    ...
    hero_panel_stat_4_value: "타베로그(일본 최대 레스토랑 예약 사이트) 온라인 예약",
    hero_trust_1: "대장 소모노 카즈히코가 직접 맡는 10석 카운터",
  ...
  zh: {
    ...
    hero_highlight_4: "可通过 Tabelog（日本大型餐厅预约网站）预约",
    hero_panel_label: "海外宾客预约说明",
    hero_panel_text:
      "可在 Tabelog 确认价格与预约条件后直接预订。",
    ...
    hero_panel_stat_4_value: "可通过 Tabelog 在线预约",
    ...
    reserve_fact_3: "当日取消将收取100%费用",
    reserve_fact_4: "周末及节假日午餐需至少提前一天预约",
    reserve_step_1: "在 Tabelog 选择希望的日期和时间",
