...
const translations = {
  ja: {
    ...
    hero_secondary_alt: "雲丹とトリュフを添えた一皿",
  ...
  en: {
    ...
    hero_secondary_alt: "A plate with sea urchin, truffle, and sushi rice in a ceramic bowl",
  ...
  ko: {
    ...
    hero_secondary_alt: "성게알과 트러플을 얹은 한 접시",
  ...
  zh: {
    ...
    hero_alt: "大阪心斋桥的鮨し禅",
    hero_secondary_alt: "海胆与松露点缀的一碟料理",
